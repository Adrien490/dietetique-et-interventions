...
import { ArchiveMultipleContactRequestsButton } from "../../archive-multiple-contact-requests";
import { DeleteMultipleContactsButton } from "../../delete-multiple-contact-requests";
import { UpdateMultipleContactRequestStatusButton } from "../../update-multiple-contact-request-status";

interface ContactRequestSelectionActionsProps {
	selectedContactIds: string[];
	isArchived?: boolean;
}

export function ContactRequestSelectionActions({
	selectedContactIds,
	isArchived,
}: ContactRequestSelectionActionsProps) {
	return (
		<DropdownMenu>
					...
					<>
									...
									<AlertDialog key={status.value}>
										...
										<AlertDialogContent>
											...
											<AlertDialogFooter>
												...
												<UpdateMultipleContactRequestStatusButton
						...
						<AlertDialog>
							...
							<AlertDialogContent>
								...
								<AlertDialogFooter>
									<AlertDialogCancel>Annuler</AlertDialogCancel>
									<ArchiveMultipleContactRequestsButton
										ids={selectedContactIds}
									>
