...
export const deleteMultipleContactRequests: ServerAction<
	null,
	typeof deleteMultipleContactRequestsSchema
> = async (_, formData) => {
	try {
		...
		const validation = deleteMultipleContactRequestsSchema.safeParse({
			ids: contactIds,
		});
