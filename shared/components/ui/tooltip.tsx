...
// Context to detect if we're already inside a TooltipProvider
...
function Tooltip({
	...
	if (hasProvider) {
		// Already inside a TooltipProvider, just return the Root
		return <TooltipPrimitive.Root data-slot="tooltip" {...props} />;
	}

	// Not inside a TooltipProvider, wrap with one
	return (
